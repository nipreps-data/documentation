...
cd ${DATASET_NAME}
datalad create -c text2git -D "Test Dataset for NiPreps derived from OpenNeuro's ${DATASET_NAME} [derivatives]" derivatives
datalad create-sibling-github --github-organization nipreps-data --github-login $USER -d ./derivatives -s github ${DATASET_NAME}-derivatives
datalad create-sibling-osf --title "NiPreps testing - ${DATASET_NAME} [derivatives]" -s osf --public --category data -d ./derivatives
datalad siblings configure -d ./derivatives -s github --publish-depends osf
